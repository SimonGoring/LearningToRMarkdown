...
Take some time to download this version of the repository and edit the chunks and the YAML header.  Make the figures equal sizes, make then different sizes, try both.  Which over-rides which?
